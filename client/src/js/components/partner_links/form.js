...
/**
 * Форма создания/редактирования дополнительных партнёрских ссылок
 */
    ...
    render() {
        ...
        return <form className="col-sm-7 form-ui table-wrapper">
            <fieldset className="product-form">
                ...
                <label className="text-warning">{edit ? 'Название редактируемой ссылки' : 'Название новой ссылки'} <span
            ...
            <fieldset>
                <div className="text-danger small">*Поля обязательные для заполнения</div>
            </fieldset>


            <button type="button" className="btn btn-warning pull-left btn-submit"
                    onClick={edit ? this.edit : this.add}>{
