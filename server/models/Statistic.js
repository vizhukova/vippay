    ...
    getByPartner(data){
        ...
        return new Promise((resolve, reject) => {
             ...
             knex.select(knex.raw(`
              ...
              (SELECT SUM(converttobasecurrency(fee_added, ${client_id}, 2)::NUMERIC) as sum_fee_added from fee WHERE partner_id = ${data.partner_id}),
              (SELECT SUM(converttobasecurrency(fee_payed, ${client_id}, 2)::NUMERIC) as sum_fee_payed from fee WHERE partner_id = ${data.partner_id}),
