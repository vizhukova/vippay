            ...
            CurrencyController.get().then((currency) => {
                ...
                return OrderController.getById(order_id).then(function (order) {
                    ...
                    payment_data.redirect_urls = {
                        "return_url": `http://payment.${info_domain}/api/payments/paypal/${order_id}?action=success`,
                        "cancel_url": `http://payment.${info_domain}/api/payments/paypal/${order_id}?action=cancel`
                    };
